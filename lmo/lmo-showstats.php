...
<?php } ?>
        ...
        <div class="row">
          <div class="col-3 offset-2 text-end"><?php echo applyFactor($punkte[$show_stat1], $pointsfaktor);
        if ($minus == 2) {
            ':' . applyFactor($negativ[$show_stat1], $pointsfaktor);
        } ?></div>
          <div class="col-4 text-center"><strong><?php echo $text[37]; ?></strong></div>
          <?php if ($show_stat2 > 0 && $show_stat1 != $show_stat2) { ?><div class="col-3"><?php echo applyFactor($punkte[$show_stat2], $pointsfaktor);
        if ($minus == 2) {
            ':' . applyFactor($negativ[$show_stat2], $pointsfaktor);
        } ?></div><?php } ?>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <?php if ($show_stat2 > 0 && $show_stat1 != $show_stat2) {
            if ($spiele[$show_stat2]) { ?><div class="col-3"><?php echo applyFactor(number_format($punkte[$show_stat2] / $spiele[$show_stat2], 2), $pointsfaktor);
            if ($minus == 2) {
                ':' . applyFactor(number_format($negativ[$show_stat2] / $spiele[$show_stat2], 2), $pointsfaktor);
            } ?></div><?php }
        } ?>
        </div>
        <div class="row">
...
?>
   ...
   <div class="row">
     <div class="col-2"><strong><?php echo $text[1001] ?></strong></div>
