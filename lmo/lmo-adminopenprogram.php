...
if (($xprogram != '') && ($xprogram != 'none') && ($xprogram != 'random')) {
    if (substr($xprogram, -4) == '.l98') {
        ...
        for ($i = 1; $i <= count($daten); $i++) {
            ...
            if ((substr($dum[0], 0, 5) == 'Round') && (substr($dum[1], 0, 2) == 'TA')) {
                $yteama[substr($dum[0], 5) - 1][substr($dum[1], 2) - 1] = $dum[2];
            }
            if ((substr($dum[0], 0, 5) == 'Round') && (substr($dum[1], 0, 2) == 'TB')) {
                $yteamb[substr($dum[0], 5) - 1][substr($dum[1], 2) - 1] = $dum[2];
            }
        }
    }
}
