...
switch ($show) {
    ...
    case 1:
        ...
        if (substr($tipp_dirtipp, -1) != '/') {
            $tipp_dirtipp = $tipp_dirtipp . '/';
        }
    ...
    case 2:
        if ($tipp_tippmodus == 1) {
            ...
            if ($tipp_rergebnis < $tipp_rtendenzdiff) {
                $tipp_rergebnis = $tipp_rtendenzdiff;
            }
            ...
            if ($tipp_rtendenzdiff < $tipp_rtendenz) {
                $tipp_rtendenzdiff = $tipp_rtendenz;
            }
            isset($_POST['xrtor']) &&
    ...
    case 3:
        ...
        if ($tipp_showname == 0 && $tipp_showemail == 0) {
            $tipp_shownick = 1;
        }
        break;
    case 4:
