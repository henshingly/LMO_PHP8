...
<div class="container">
  <div class="row">
    <div class="col d-flex justify-content-center"><h1><?php echo $text['tipp'][0] . ' ';
    if (isset($titel)) {
        echo $titel;
    } ?></h1></div>
  </div>
  <div class="row">
    ...
    if ($_SESSION['lmotipperok'] == 5) {
        ...
        if ($viewermode == 1) {
            ...
            switch ($todo) {
                case 'edit':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippedit.php');
                    break;
                case 'einsicht':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippeinsicht.php');
                    break;
                case 'tabelle':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tipptabelle.php');
                    break;
                case 'fieber':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippfieber.php');
                    break;
                case 'wert':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippwert.php');
                    break;
                case 'daten':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippdaten.php');
                    break;
                case 'newligen':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippnewligen.php');
                    break;
                case 'delligen':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippdelligen.php');
                    break;
                case 'pwchange':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tipppwchange.php');
                    break;
                case 'delaccount':
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippdelaccount.php');
                    break;
                case 'info':
                    require (PATH_TO_LMO . '/lmo-showinfo.php');
                    break;
                default:
                    require (PATH_TO_ADDONDIR . '/tipp/lmo-tipppad.php');
                    break;
            }
        }
    }
