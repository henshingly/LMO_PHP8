    ...
    for ($x = 1; $x <= $anzteams; $x++) {
        ...
        if ($teamn[$i] != '' || $strafp[$i] != 0 || $strafm[$i] != 0 || $torkorrektur1[$i] != 0 || $torkorrektur2[$i] != 0) {
            ...
            if ($strafp[$i] != 0 || $strafm[$i] != 0) {
                ...
                // Ab ST
                if ($strafdat[$i] != 0)
                    $lmo_tabellennotiz .= " ({$text[524]} {$text[145]} {$strafdat[$i]})";
            }
            // Straf-/Bonustore
            ...
            echo "<a data-bs-toggle='tooltip' data-bs-placement='right' data-bs-html='true' data-bs-original-title='" . $lmo_tabellennotiz . "'> <i class='bi bi-info-square text-info' style='font-size: 1.3rem;'></i></a>";
            $lmo_tabellennotiz = '';
        }
        ?>
            </div>
