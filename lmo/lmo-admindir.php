...
?>
  ...
  <dd><small><?php echo datefmt_format($fmt, filemtime(PATH_TO_LMO . '/' . $dirliga . $liga['file_name'])) . ' / ' . $liga['rundenbezeichnung'] . ' ' . $liga['aktueller_spieltag'] ?></small></dd><?php
}
if ($liga_counter == 0) {
    echo '<li>[' . $text[223] . ']</li>';
}
